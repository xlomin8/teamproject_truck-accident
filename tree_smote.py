...
ss = StandardScaler()
ss.fit(X_train_res)
train_scaled = ss.transform(X_train_res)
...
print('Train_Accuracy: ', dt_clf.score(X_train_res, Y_train_res),'\n')
...
lr.fit(train_scaled, Y_train_res)

#훈련용 데이터로 학습한 결과
print(lr.score(train_scaled, Y_train_res))
